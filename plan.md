...
- [ ] Playtest with the target audience (or an age-appropriate proxy) -- including the new jump-over obstacles and gaps together, since obstacles are now placed close enough to some gaps that they may chain into a harder combined challenge than either alone
